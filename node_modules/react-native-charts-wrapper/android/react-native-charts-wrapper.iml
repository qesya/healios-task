...
<module external.linked.project.id=":react-native-charts-wrapper" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../Example/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.facebook.react:react-native:0.61.1@aar" level="project" />
